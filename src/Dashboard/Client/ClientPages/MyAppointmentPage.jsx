    ...
    <section className="flex h-full flex-col">
      ...
      <div className="mt-3 grid min-h-0 flex-1 gap-3 lg:grid-cols-[1.5fr_1fr]">
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="grid w-full grid-cols-1 overflow-hidden border-2 border-[#2d2620]/20 text-xs tracking-widest uppercase sm:grid-cols-3">
            {tabs.map((tab, index) => {
          ...
          <div className="relative mt-3 flex min-h-0 flex-1 flex-col border-2 border-[#2d2620]/20 bg-white/90 p-3 sm:p-4">
            <div className="absolute -top-10 -right-10 h-24 w-24 rounded-full bg-[#2d2620]/5"></div>
            {activeAppointments.length === 0 ? (
              ...
              <div className="scrollbar-hidden mt-5 flex max-h-[50vh] min-h-0 min-h-[50vh] flex-1 flex-col overflow-y-auto pr-3 md:min-h-0">
