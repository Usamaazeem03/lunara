    ...
    <section className="flex flex-col gap-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <select className="border-ink/30 text-ink border-2 bg-white px-4 py-2 text-xs tracking-widest uppercase focus:outline-none">
      ...
      <div className="border-ink/20 flex flex-wrap items-center gap-2 rounded-2xl border-2 bg-white/90 p-2">
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`rounded-xl px-4 py-2 text-xs tracking-widest uppercase transition ${
      ...
      <section className="border-ink/20 relative flex flex-col border-2 bg-white/90 p-4 sm:p-5">
        <div className="bg-ink/5 absolute -top-10 -right-10 h-24 w-24 rounded-full"></div>
        <div className="flex items-start justify-between gap-3">
          <div>
          ...
          <div className="mt-4 space-y-3">
            {exportReports.map((label) => (
              ...
              >
                ...
                <button className="border-ink/30 text-ink hover:border-ink border-2 px-3 py-1 text-[0.65rem] tracking-widest uppercase transition">
                  Download
                </button>
              </div>
            ))}
...
const RevenueTrendChart = ({ labels, actual, target }) => {
  ...
  return (
    <div>
      ...
      <div className="text-ink-muted mt-2 grid grid-cols-6 text-xs tracking-widest uppercase">
        {labels.map((label) => (
      ...
      <div className="text-ink-muted mt-3 flex items-center gap-4 text-xs tracking-widest uppercase">
        <span className="flex items-center gap-2">
          <span className="bg-ink h-2 w-2 rounded-full" />
          Actual Revenue
        </span>
        <span className="flex items-center gap-2">
        ...
        return (
          <div key={item.name} className="flex flex-col items-center gap-2">
            <div className="flex h-40 w-full items-end justify-center">
              <div
                className="border-ink/10 w-full rounded-xl border"
                style={{
                  height: `${height}px`,
                  background:
